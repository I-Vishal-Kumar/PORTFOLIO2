            ...
            >
                ...
                <section className="rounded-sm bg-slate-200 flex flex-col items-center h-[95%] w-[25%] py-4">
                    ...
                    <div className="flex w-full items-center  px-2 border-2 border-solid">
                        <div className="w-[90%] h-full flex justify-center items-center ">
                            <div className="bg-slate-300 flex justify-center items-center rounded-md w-[70%] aspect-square">
                                <Image
                                    src={"/programmer.png"}
                                    alt="profile"
                                    width={100}
                    ...
                    <div className="text-center py-2">
                        ...
                        <div className="mt-3 px-3 text-[#262626] font-itim ">
                            <p className="text-sm leading-5 ">
                                Hey there! I&apos;m Vishal , a dedicated web
                                developer with a flair for innovation and
                                problem-solving.
                            </p>
                        </div>
                    </div>
                ...
                <section className="rounded-sm bg-slate-200 h-[95%] gap-y-5 flex flex-col justify-center w-[10%]">
                    ...
                    >
                        ...
                        <p className="font-itim capitalize pt-2 text-sm">
                            about
                        </p>
                    </motion.div>
                    <motion.div
            ...
            <div className="rounded-full absolute flex-col top-0 right-0 flex items-end gap-y-2 pr-2 justify-center">
                ...
                {setting && (
                    <motion.div
                        ...
                        animate="visible"
                    >
                        {["spring", "winter", "summer", "autumn"].map(
                            (ele, idx) => (
                                <motion.div
