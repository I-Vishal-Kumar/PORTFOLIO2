      ...
      (entries) => {
        entries.forEach((entry) => {
          if (entry.isIntersecting) {
            ...
            // console.log(entry.target.id, entry.target);
            // GSAP animation for the active section
            // tl.current = gsap.timeline();
            // tl.current.to(entry.target, { scale: 1.1, duration: 0.5 });
          } else {
      ...
      >
        ...
        >
          ...
          <div
            ...
            id="skills"
            className=" trigger h-full pt-[10%] w-full snap-align-start-10   flex justify-center items-center"
          >
            <Image
              src={"/skillTree.svg"}
              alt="skilltree"
